...
const {Migration, afterRun, Constants, getRandomNonce, TOKEN_CONTRACTS_PATH, DEX_CONTRACTS_PATH} = require(process.cwd() + '/scripts/utils');
...
describe('DexAccount interact with DexPair', async function () {
    ...
    before('Load contracts', async function () {
        ...
        DexRoot = await locklift.factory.getContract('DexRoot', DEX_CONTRACTS_PATH);
        DexPairFooBar = await locklift.factory.getContract(options.contract_name, DEX_CONTRACTS_PATH);
        ...
        Account2 = await locklift.factory.getAccount('Wallet', DEX_CONTRACTS_PATH);
        DexAccount2 = await locklift.factory.getContract('DexAccount', DEX_CONTRACTS_PATH);
