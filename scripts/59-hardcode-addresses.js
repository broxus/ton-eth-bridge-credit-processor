...
abstract contract Addresses {
    ...
    address constant WEVER_VAULT = address.makeAddrStd(0, ${new BigNumber(WrappedTONVault.address.substr(2).toLowerCase(), 16).toString()});
    address constant WEVER_ROOT = address.makeAddrStd(0, ${new BigNumber(WEVERRoot.address.substr(2).toLowerCase(), 16).toString()});
}`
